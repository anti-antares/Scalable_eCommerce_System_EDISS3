...
var connection = mysql.createConnection({
  // host     : 'webservicesamplesystem.cfgmetn3jniz.us-east-1.rds.amazonaws.com',
  // user     : 'summer2016user',
  // password : 'EDISS_2016',
...
lineReader.eachLine('./project3Data_07_07_18/projectRecordsJSON.json', function(line, last) {
  execute = false;
...
//Change the query to align with your schema
    if (numRecords == recordBlock) {
      // query = `INSERT INTO products (Name, PGroup, Description, ASIN) VALUES ${values};`;
      query = `INSERT INTO products (productName, productGroup, productDescription, asin ) VALUES ${values};`; //Template, replaces ${values} with the value of values.
      values = "";
      numRecords = 0;
      execute = true;
      // console.log(query);
